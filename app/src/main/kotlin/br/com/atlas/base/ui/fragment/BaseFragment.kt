...
import br.com.atlas.base.ui.activity.ActivityAction
import br.com.atlas.base.ui.activity.BaseActivity
...
abstract class BaseFragment : Fragment() {
    ...
    fun showSnack(view: View?, message: String, color: Int? = null) {
        if (activity is BaseActivity) {
            (activity as BaseActivity).showSnack(view, message, color)
        }
    }
}
